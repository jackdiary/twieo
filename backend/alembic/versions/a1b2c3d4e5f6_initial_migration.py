...
def upgrade() -> None:
    ...
    sa.Column('total_distance', sa.Float(), server_default=sa.text('0.0'), nullable=False),
    sa.Column('total_runs', sa.Integer(), server_default=sa.text('0'), nullable=False),
    sa.Column('avatar_url', sa.String(), nullable=True),
    sa.Column('longest_run', sa.Float(), server_default=sa.text('0.0'), nullable=False),
    sa.Column('best_pace', sa.Float(), server_default=sa.text('0.0'), nullable=False),
    sa.ForeignKeyConstraint(['user_id'], ['users.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
