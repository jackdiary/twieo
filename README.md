<img width="415" height="796" alt="image" src="https://github.com/user-attachments/assets/012c3934-9550-42a0-92b4-585ca6d5a961" />
...
-  **오프라인 저장**: 네트워크 오류 시 기기에 임시 저장하여 기록 유실 방지
-  **지도 최적화**: 캐시된 위치를 활용한 빠른 로딩 및 부드러운 지도 경험
